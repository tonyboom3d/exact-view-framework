            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {shouldShowTag && (
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 translate-y-2 -translate-x-5 sm:translate-y-0 sm:translate-x-0">
